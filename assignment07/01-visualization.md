...
![grafana](./assets/floor-plan.png)
![grafana](./assets/1.png)
</br> 

การแสดงผ่าน Grafana โดยใช้กราฟ ดังต่อไปนี้
### 1. Map Chart

![Map](./assets/floorplan.png)
</br> 
ใช้ในการนำเสนอค่า sensor อุณหภูมิทั้ง 10 ตัว ให้เห็นภาพได้ง่ายขึ้นโดยในที่นี้เราใช้ map บ้านเพื่อแสดงแผนผังห้องพร้อมข้อมูลอุณหภูมิในแต่ละห้องของบ้าน การใช้ Map Chart เพื่อให้เห็นความแตกต่างของอุณหภูมิในแต่ละโซนได้ง่ายขึ้นและง่ายต่อการนำเสนอ
</br> 
### 2. Gauge Chart
...
ใช้สำหรับแสดงค่าความเข้มแสงของเซ็นเซอร์ในแต่ละโซน การใช้กราฟแท่งช่วยให้ผู้ใช้เห็นปริมาณแสงในห้องแต่ละห้องได้ง่ายขึ้น และสามารถนำไปเปรียบเทียบระหว่างโซนต่างๆ ได้ง่ายขึ้น
</br> 
### 4. Line Chart
 
![Line](./assets/3.png)
</br> 
ใช้ในการแสดงข้อมูลการเปลี่ยนแปลงของค่าต่างๆ โดยใน Grafana ใช้ในการแสดงค่า อุณหภูมิ ซึ่งกราฟเส้นจะช่วยให้เห็นแนวโน้มของค่าในช่วงเวลาที่กำหนด เหมาะกับการมอนิเตอร์ความผันผวนของข้อมูลได้
